...
def initialize():
    ...
    chat_llm = models.get_ollama_chat(model_name="llama3.2:3b", temperature=0.2)
    ...
    # chat_llm = models.get_groq_chat(model_name="llama-3.1-70b-versatile", temperature=0.2)
